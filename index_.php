...
<head>
    ...
    <title>Abz | Game Portal</title>

    <meta name="description" content="Abz - Online game portal">
    <meta name="keywords" content="Abz, online game, game portal">
    <meta name="author" content="Abz">
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/default-skin.css">
    ...
    <!-- Prism -->
    <link rel="stylesheet" type="text/css" href="assets/css/prism-tomorrow.css">
...
<!-- END: Top Contacts -->
    ...
    <nav class="nk-navbar nk-navbar-top nk-navbar-sticky">
        ...
        <li>
            <a href="https://nkdev.info/docs/goodgames-html/">
                Documentation
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    ...
                    <div class="nk-post-date pull-right"><span class="fa fa-calendar"></span> Jul 23, 2016</div>
                </div>
                <!-- END: Post -->
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    ...
                    <div class="nk-gap"></div>
                    <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Read More</a>
                    <div class="nk-post-date pull-right"><span class="fa fa-calendar"></span> Jul 3, 2016</div>
                </div>
                <!-- END: Post -->
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-post-by">
                                <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" class="img-circle" width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 23, 2016
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door...</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <h2 class="nk-post-title h4"><a href="blog-article.html">At first, for some time, I was not able to answer</a></h2>
                            <div class="nk-post-by">
                                <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" class="img-circle" width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 3, 2016
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>This little wandering journey, without settled place of abode, had been so unpleasant to me, that my own house, as I called it to myself, was a perfect settlement to me compared to that...</p>
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        ...
        <div class="col-lg-9 col-md-7">
            <h2 class="nk-post-title h4"><a href="blog-article.html">At length one of them called out in a clear</a></h2>
            <div class="nk-post-date mt-10 mb-10">
                <span class="fa fa-calendar"></span> Jul 3, 2016
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        ...
        <div class="col-lg-9 col-md-7">
            <h2 class="nk-post-title h4"><a href="blog-article.html">He made his passenger captain of one</a></h2>
            <div class="nk-post-date mt-10 mb-10">
                <span class="fa fa-calendar"></span> Jul 23, 2016
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    ...
    <div class="nk-post-date mt-10 mb-10">
        <span class="fa fa-calendar"></span> Aug 27, 2016
        <span class="fa fa-comments"></span> <a href="#">7 comments</a>
    </div>
    <div class="nk-post-text">
        <p>And she went on planning to herself how she would manage it. `They must go by the carrier,' she thought; `and how funny it'll seem, sending presents to one's own feet!...</p>
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        ...
        <div class="col-lg-9 col-md-7">
            <h2 class="nk-post-title h4"><a href="blog-article.html">For good, too though, in consequence</a></h2>
            <div class="nk-post-date mt-10 mb-10">
                <span class="fa fa-calendar"></span> Aug 14, 2016
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        ...
                        <div class="nk-product-cont">
                            ...
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-rating" data-rating="1.5"> <i class="fa fa-star"></i> <i class="fa fa-star-half-o"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i></div>
                            <div class="nk-gap-1"></div>
...
<div class="nk-widget nk-widget-highlighted">
    ...
    <div class="nk-widget-content">
            ...
            <div class="nk-widget-post">
                ...
                <div class="nk-post-date"><span class="fa fa-calendar"></span> Sep 18, 2016</div>
            </div>
            ...
            <div class="nk-widget-post">
                ...
                <div class="nk-post-date"><span class="fa fa-calendar"></span> Sep 5, 2016</div>
            </div>
            ...
            <div class="nk-widget-post">
                ...
                <div class="nk-post-date"><span class="fa fa-calendar"></span> Aug 27, 2016</div>
            </div>
    ...
    <div class="nk-copyright">
        <div class="container">
            <div class="nk-copyright-left">
                Copyright &copy; 2017 | Design<a href="#" target="_blank">by</a><a href="#" target="_blank">Abz</a>
            </div>
...
<!-- nK Share -->
<script src="assets/js/nk-share.js"></script>
